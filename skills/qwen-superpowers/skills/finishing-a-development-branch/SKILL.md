...
## Steps
1. Verify everything is green (see `/verification-before-completion`). Don't finish on red.
...
- If anything is unverified, it isn't finished — go back to `/verification-before-completion`.
