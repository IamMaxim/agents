...
4. Save the plan to a file (e.g. `docs/plans/<topic>.md`) so `/executing-plans` can follow it.
...
- Flag risky steps and put them behind a worktree (`skills/using-git-worktrees/SKILL.md`).
